...
def create_user():
    ...
    cur.execute("INSERT INTO users (username, password, number_phone, email, email_verified) VALUES (%s, %s, %s, %s, %s)",
                (username, password, number_phone, email, email_verified))
...
@app.route('/api/user_update/<int:user_id>', methods=['PUT'])
